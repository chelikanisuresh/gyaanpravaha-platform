...
import { getChapter, type Chapter, type Section } from '@/lib/skt-chapter-content'
import { getSktWordMap, type WordMap } from '@/lib/skt-tooltip-words'
  ...
  if (showSummary) return (
    <div style={{ minHeight: '100vh', background: '#F8FAF9' }}>
      <div style={{ background: '#1B4332', padding: '14px 28px', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <button onClick={() => router.push('/student/dashboard?section=sanskrit')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px' }}>Sanskrit</button>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
        <p style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: '13px', color: 'white' }}>{chapter.title}</p>
      </div>
      <SummaryScreen chapter={chapter} onStartQuiz={() => router.push(`/student/skt-quiz/${chapterId}`)}/>
    </div>
  )
    ...
    <div style={{ minHeight: '100vh', background: '#F8FAF9' }}>
      ...
      <div style={{ background: '#1B4332', padding: '14px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          {/* Breadcrumb: Dashboard → Sanskrit → Chapter */}
          ...
          <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
          <button onClick={() => router.push('/student/dashboard?section=sanskrit')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px', borderRadius: '6px' }}>
            Sanskrit
          </button>
          <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
