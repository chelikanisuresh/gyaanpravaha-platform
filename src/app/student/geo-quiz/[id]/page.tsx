...
import { getGeoQuiz, type Question } from '@/lib/geo-quiz-content'
...
export default function QuizPage() {
  ...
  const quiz    = getGeoQuiz(chapterId)
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8FAF9' }}>
      ...
      <div style={{ background: '#1B4332', padding: '14px 28px', display: 'flex', alignItems: 'center', gap: '6px', position: 'sticky', top: 0, zIndex: 100 }}>
        <button onClick={() => router.push('/student/dashboard?section=geo')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.5)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px' }}>
          Dashboard
        </button>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
        <button onClick={() => router.push('/student/dashboard?section=geo')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px' }}>
          English
        </button>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
        <button onClick={() => router.push(`/student/geo-chapter/${chapterId}`)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px' }}>
          {chapter.title}
        </button>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
      ...
      {phase === 'results' && (
        <ResultsScreen
          ...
          totalMarks={quiz.totalMarks}
          onRetry={handleRetry}
          onBack={() => router.push('/student/dashboard?section=geo')}
        />
      )}
    </div>
  )
