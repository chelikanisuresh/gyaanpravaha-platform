...
import { getSciQuiz, type Question } from '@/lib/sci-quiz-content'
...
export default function QuizPage() {
  ...
  const quiz    = getSciQuiz(chapterId)
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8FAF9' }}>
      ...
      <div style={{ background: '#1B4332', padding: '14px 28px', display: 'flex', alignItems: 'center', gap: '6px', position: 'sticky', top: 0, zIndex: 100 }}>
        <button onClick={() => router.push('/student/dashboard?section=science')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.5)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px' }}>
          Dashboard
        </button>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
        <button onClick={() => router.push('/student/dashboard?section=science')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px' }}>
          English
        </button>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
        <button onClick={() => router.push(`/student/sci-chapter/${chapterId}`)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-body)', fontSize: '13px', padding: '4px 8px' }}>
          {chapter.title}
        </button>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '13px' }}>›</span>
      ...
      {phase === 'results' && (
        <ResultsScreen
          ...
          totalMarks={quiz.totalMarks}
          onRetry={handleRetry}
          onBack={() => router.push('/student/dashboard?section=science')}
        />
      )}
    </div>
  )
